    ...
    <div className="my-52 mx-8">
      <section className="flex flex-row max-lg:flex-col justify-between items-center max-lg:mx-4">
        ...
        <article className="bg-gray-300 flex flex-col items-center shadow-xl rounded-md p-8 m-4 max-lg:mx-auto lg:w-[54%] lg:h-[380px] lg:hover:scale-110 duration-200 lg:hover:cursor-pointer">
          ...
          <p>
            <span className="text-blue-500 text-lg font-bold">Ciência da computação</span> <br /> Cursando o 5º período pela Universidade Anhembi Morumbi - SP
          </p>
        </article>
        ...
        <article className="bg-gray-300 flex flex-col items-center shadow-xl rounded-md p-8 m-4 max-lg:mx-auto lg:h-[380px] lg:hover:scale-110 duration-300 lg:hover:cursor-pointer">
          ...
          <p className="m-2">
            <span className="text-blue-500 text-lg font-bold">Rocketseat</span> desenvolvimento web focado em JavaScript, React, Vue e Angular <br />
            <span className="text-blue-500 text-lg font-bold">Alura</span> desenvolvimento web focado em Node, Express, Mongo DB, Mongoose e APIs
          </p>
        </article>
        <article className="bg-gray-300 flex flex-col items-center shadow-xl rounded-md p-8 m-4 max-lg:mx-auto lg:h-[380px] lg:hover:scale-110 duration-200 lg:hover:cursor-pointer">
          ...
          <p className="drop-shadow-lg">
            <span className="text-blue-500 text-lg font-bold">Front-end</span> HTML, CSS, JavaScript, Bootstrap, React, Vue, Angular <br />
            <span className="text-blue-500 text-lg font-bold">Back-end</span> Node JS, Express, Mongo DB, Mongoose e Cors para construção e integração de APIs. <br />
            <span className="text-blue-500 text-lg font-bold">Database</span> MySQL, Maria DB, PostegreSQL e também SQL server. <br />
          </p>
        </article>
      </section>
      <section>
        <article className="bg-gray-300 flex flex-col items-center shadow-xl rounded-md p-8 m-4 max-lg:mx-auto lg:h-[380px]">
            <h4 className="m-4 text-blue-700 text-2xl text-center font-bold drop-shadow-lg">
              Experiências
            </h4>
            <p className="drop-shadow-lg">
              <span className="text-blue-500 text-lg font-bold">Web </span>Proeficiência em desenvolvimento web responsivo na criação de página, blogs, posters, anúncios, portifólios, e-commerce e banners.<br />
            </p>
          </article>
      </section>
    </div>
