  ...
  return (
    <div className="my-52 mx-8">
      <section className="flex flex-row max-lg:flex-col justify-between items-center max-lg:mx-16">
        <article className="bg-gray-200 flex flex-col items-center shadow-xl rounded-lg p-5 m-4 max-lg:mx-auto max-lg:w-[90%] lg:w-[50%] lg:h-[380px] lg:hover:scale-110 lg:hover:cursor-pointer duration-100">
        ...
        <article className="bg-gray-200 flex flex-col items-center shadow-xl rounded-lg p-5 m-4 max-lg:mx-auto max-lg:w-[90%] lg:h-[380px] lg:hover:scale-110 lg:hover:cursor-pointer duration-100">
          <h4 className="m-4 text-lg text-center font-bold">
            Sobre mim
          </h4>
          <p>
