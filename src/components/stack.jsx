...
const Stack = () => {
  ...
  return (
    <div className="my-32">
      <p className="mx-40 mb-4 text-gray-800 text-lg">
      ...
      <article className="flex mx-24 my-10">
        { isHTML ? <></> : <article className=" block text-white bg-red-500 rounded-md shadow-lg drop-shadow-md p-4 text-center text-lg">
        ...
        {
          isCSS ? <p className="drop-shadow-lg text-xl"></p> : <article className=" block text-blue-700 bg-gray-200 rounded-md shadow-lg drop-shadow-md p-4 text-center text-lg">
        ...
        {
          isBootStrap ? <p className="drop-shadow-lg text-xl"></p> : <article className=" block text-gray-300 bg-blue-800 rounded-md shadow-lg drop-shadow-md p-4 text-center text-lg">
        ...
        {
          isTailwindCSS ? <p className="drop-shadow-lg text-xl"></p> : <article className=" block text-blue-700 bg-gray-200 rounded-md shadow-lg drop-shadow-md p-4 text-center text-lg">
      ...
      <article className="flex mx-24 my-10">
      {
          isJavaScript ? <p className="drop-shadow-lg text-xl"></p> : <article className=" block text-black bg-yellow-200 rounded-md shadow-lg drop-shadow-md p-4 text-center text-lg">
        ...
        {
          isJquery ? <p className="drop-shadow-lg text-xl"></p> : <article className=" block text-gray-300 bg-blue-800 rounded-md shadow-lg drop-shadow-md p-4 text-center text-lg">
        ...
        {
        isReact ? <p className="drop-shadow-lg text-xl"></p> : <article className=" block text-blue-700 bg-gray-200 rounded-md shadow-lg drop-shadow-md p-4 text-center text-lg">
        ...
        {
        isNode ? <p className="drop-shadow-lg text-xl"></p> : <article className=" block text-gray-200 bg-green-500 rounded-md shadow-lg drop-shadow-md p-4 text-center text-lg">
